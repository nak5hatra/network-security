...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            save_numpy_array_data(self.data_transformation_config.transformd_train_file_path, array=train_arr)
            save_numpy_array_data(self.data_transformation_config.transformd_test_file_path, array=test_arr)
            ...
            data_transformation_artifact = DataTransformationArtifact(
                ...
                transformed_train_file_path = self.data_transformation_config.transformd_train_file_path,
                transformed_test_file_path = self.data_transformation_config.transformd_test_file_path
            )
